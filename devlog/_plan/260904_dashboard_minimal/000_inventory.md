...
The temporary capture pack used for this inventory was removed after review. The route,
control-count, and source inventory below retain the conclusions without retaining local runtime
