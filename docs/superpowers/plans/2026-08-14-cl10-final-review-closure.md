...
the actual response contract. Verification now checks synchronous refusal and ownership preservation
under the normal test deadline. This changes the test oracle, not the fail-fast/no-polling runtime
