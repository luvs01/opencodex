...
Complete-block discovery uses monotonic delimiter scans, so malformed blocks are preserved with
processing proportional to their input length even when they contain long whitespace runs.
