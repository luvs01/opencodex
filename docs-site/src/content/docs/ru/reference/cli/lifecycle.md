...
loopback, если действующая конфигурация прокси направляет запрос напрямую. Учётные данные в URL, query, фрагменты, редиректы, слишком большие ответы и невалидные
