...
export const CAPABILITIES: readonly Capability[] = [
  ...
  },
  {
    ...
    summary: "Show or toggle the native Claude, Claude Desktop, Codex, and Grok integrations, and read the Cursor status (which builds are installed, gateway values).",
    routes: [
